<template>
  <div>
    ...
    <h1 class="animated slideInUp" style="text-align:center;margin-top:40px;">Check out my <a href="https://github.com/nunogois" target="_blank">GitHub</a> for some open-source projects!</h1>
  </div>
</template>
